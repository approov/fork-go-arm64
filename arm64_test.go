...
func Test_umov_32bit(t *testing.T) {
	type args struct {
		instructionValue uint32
		address          uint64
	}
	tests := []struct {
		...
		{
			name: "umov.h w12, v0[0]",
			args: args{
				instructionValue: binary.LittleEndian.Uint32([]byte{0x0c, 0x3c, 0x02, 0x0e}),
				address:          0,
			},
			want:    "umov w12, v0.h[0], v2",
			wantErr: false,
		},
	}
	for _, tt := range tests {
...
func Test_ext_16bv(t *testing.T) {
	type args struct {
		instructionValue uint32
		address          uint64
	}
	tests := []struct {
		...
		{
			name: "ext.16b	v1, v0, v0, #8",
			args: args{
				instructionValue: binary.LittleEndian.Uint32([]byte{0x01, 0x40, 0x00, 0x6e}),
				address:          0,
			},
			want:    "ext v1.16b, v0.16b, v0.16b, #8",
			wantErr: false,
		},
	}
	for _, tt := range tests {
...
func Test_fsub_vector(t *testing.T) {
	type args struct {
		instructionValue uint32
		address          uint64
	}
	tests := []struct {
		...
		{
			name: "fsub.2d	v0, v0, v1",
			args: args{
				instructionValue: binary.LittleEndian.Uint32([]byte{0x00, 0xd4, 0xe1, 0x4e}),
				address:          0,
			},
			want:    "fsub v0.2d, v0.2d, v1.2d",
			wantErr: false,
		},
	}
	for _, tt := range tests {
...
func Test_cmhs_vector(t *testing.T) {
	type args struct {
		instructionValue uint32
		address          uint64
	}
	tests := []struct {
		...
		{
			name: "cmhs.2d	v3, v0, v1",
			args: args{
				instructionValue: binary.LittleEndian.Uint32([]byte{0x03, 0x3c, 0xe1, 0x6e}),
				address:          0,
			},
			want:    "cmhs v3.2d, v0.2d, v1.2d",
			wantErr: false,
		},
	}
	for _, tt := range tests {
